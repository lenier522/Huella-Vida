...
public class Tools {
    ...
    public static String decimalFormat(double value) {
        ...
        if (value > -1 && value < 0) {
            return "-0" + df.format(value).split("-")[1];
        }
        return df.format(value);
    }

    public static String decimalFormat3(double value) {
    ...
    public static void methodShare(Activity act, double val) {
        try {

            // string to share
            String body = String.format(act.getString(R.string.share_text), decimalFormat3(val) + " Kg CO₂");
    ...
    public static String getCountry(Activity activity, String country) {
        ArrayList<String> listCountries;
        String[] countries = activity.getResources().getStringArray(R.array.countries);
        String[] countries_en = activity.getResources().getStringArray(R.array.countries_en);
        ...
        return countries_en[listCountries.indexOf(country)];
    }

    public static String getCountry(Context context, int country) {

        String[] countries_en = context.getResources().getStringArray(R.array.countries_en);
        return countries_en[country];
    }
